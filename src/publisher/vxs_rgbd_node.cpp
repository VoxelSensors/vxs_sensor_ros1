...
namespace vxs_ros1
{
    ...
    VxsRGBDPublisher::VxsRGBDPublisher(const ros::NodeHandle &nh,
                                       const ros::NodeHandle &nhp) : nh_(nh),                                              //
                                                                     ...
                                                                     observation_window_update_server_(                    //
                                                                         nhp_.advertiseService(                            //
                                                                             ...
                                                                             &VxsRGBDPublisher::UpdateObservationWindowCB, //
                                                                             this))
    {
        ...
        frame_publishing_thread_ = std::make_shared<std::thread>(std::bind(&VxsRGBDPublisher::SensorPublishingLoop, this));
    ...
    VxsRGBDPublisher::~VxsRGBDPublisher()
    {
    ...
    bool VxsRGBDPublisher::InitSensor()
    {
        // Detect sensor
    ...
    void *VxsRGBDPublisher::GetNextSensorFrame(int &N)
    {
    ...
    cv::Mat VxsRGBDPublisher::GetNextRGBFrame()
    {
        cv::Mat frame;
    ...
    void VxsRGBDPublisher::SensorPollingLoop()
    {
        ...
        while (!flag_shutdown_request_)
        {
            ...
            std::future<void *> sensor_future = std::async(std::launch::async, &VxsRGBDPublisher::GetNextSensorFrame, this, std::ref(N));
            cv::Mat rgb_img;
    ...
    cv::Mat VxsRGBDPublisher::UnpackFrameSensorData(float *frameXYZ, std::vector<cv::Vec3f> &points)
    {
    ...
    void VxsRGBDPublisher::SensorPublishingLoop()
    {
        while (!flag_shutdown_request_)
        {
            RawSensorFrame frame_data;
    ...
    void VxsRGBDPublisher::RGBPublishingLoop()
    {
        while (!flag_shutdown_request_)
        {
            RGBFrame rgb_data;
    ...
    bool VxsRGBDPublisher::UpdateObservationWindowCB(
