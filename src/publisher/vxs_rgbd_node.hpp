...
namespace vxs_ros1
{
    ...
    {
        static constexpr int DEFAULT_BINNING = 0;
        static const float DEFAULT_PREFILTERING_THRESH;        // = 2.0;
        static constexpr int DEFAULT_POSTFILTERING_THRESH = 5; //

        static const float DEFAULT_FILTERP1X; // = 0.1;
        static const float DEFAULT_FILTERP1Y; // = 0.1;
        static constexpr int DEFAULT_TEMPORAL_THRESH = 4;
        static constexpr int DEFAULT_SPATIAL_THRESH = 10;

        static constexpr int DEFAULT_MEDIAN_REJECTION_THRESH = 5; //
    ...
    public:
        ...
        static constexpr int SENSOR_WIDTH = 300;
        static constexpr int SENSOR_HEIGHT = 300;

        //! Default RGB dimensions
        static constexpr int DEFAULT_RGB_WIDTH = 640;
        static constexpr int DEFAULT_RGB_HEIGHT = 480;

        //! Maximum depth of pubishing queue
        static const int MAX_QUEUE_DEPTH = 100;

        VxsRGBDPublisher(const ros::NodeHandle &nh, const ros::NodeHandle &nhp);
        ~VxsRGBDPublisher();
    ...
    private:
        ...
        std::shared_ptr<ros::Publisher> depth_info_publisher_;
        std::shared_ptr<ros::Publisher> cam_info_publisher_;
        std::shared_ptr<ros::Publisher> imu_publisher_;
        std::shared_ptr<ros::Publisher> rgb_publisher_;
        ...
        //! Name of color camera info topic
        std::string color_info_topic_;
        //! Name of depth topic
        std::string depth_topic_;
        //! Name of depth camera info topic
        ...
        void PublishRGBImage(const cv::Mat &rgb, const ros::Time &stamp);
